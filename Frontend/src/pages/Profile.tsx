...
const Profile = () => {
    ...
    const resolvedBanner = profile?.banner
        ? (profile.banner.startsWith('http') ? profile.banner : `http://localhost:5000/${profile.banner}`)
        : '';

    if (loading) {
        return (
            <div className="flex min-h-screen items-center justify-center bg-[#0A0D14] text-gray-200">
                <div className="text-center">
                    <div className="inline-block h-12 w-12 animate-spin rounded-full border-4 border-solid border-blue-600 border-r-transparent"></div>
                    <p className="mt-4 text-lg font-semibold text-gray-300">Loading profile...</p>
                </div>
            </div>
        );
    }
    ...
    if (!profile) {
        return (
            <div className="flex min-h-screen items-center justify-center bg-[#0A0D14] text-gray-200">
                <div className="text-center">
                    <p className="text-lg text-gray-300">Profile not found</p>
                    <button
                        onClick={() => navigate('/dashboard')}
                        className="mt-4 rounded-lg bg-gradient-to-r from-amber-500 to-orange-500 px-6 py-2 font-semibold text-[#111827] transition-all hover:from-amber-400 hover:to-orange-400"
                    >
                        Go to Dashboard
                    </button>
                </div>
    ...
    return (
        <div className="profile-theme min-h-screen bg-[#0A0D14] text-gray-200 relative overflow-x-hidden">
            <style>
                {`
                    .profile-theme .profile-content .bg-white,
                    .profile-theme .profile-content .bg-gray-50,
                    .profile-theme .profile-content .bg-orange-50,
                    .profile-theme .profile-content .bg-blue-50 {
                        background-color: rgba(18, 22, 32, 0.84) !important;
                    }

                    .profile-theme .profile-content .border-gray-100,
                    .profile-theme .profile-content .border-gray-200,
                    .profile-theme .profile-content .border-gray-300,
                    .profile-theme .profile-content .border-blue-200,
                    .profile-theme .profile-content .border-orange-200 {
                        border-color: rgba(255, 255, 255, 0.14) !important;
                    }

                    .profile-theme .profile-content .text-gray-900,
                    .profile-theme .profile-content .text-gray-800,
                    .profile-theme .profile-content .text-blue-700,
                    .profile-theme .profile-content .text-orange-700 {
                        color: #f3f4f6 !important;
                    }

                    .profile-theme .profile-content .text-gray-700,
                    .profile-theme .profile-content .text-gray-600,
                    .profile-theme .profile-content .text-gray-500,
                    .profile-theme .profile-content .text-gray-400,
                    .profile-theme .profile-content .text-blue-600,
                    .profile-theme .profile-content .text-orange-600 {
                        color: #9ca3af !important;
                    }

                    .profile-theme .profile-content input,
                    .profile-theme .profile-content textarea,
                    .profile-theme .profile-content select {
                        background-color: rgba(255, 255, 255, 0.05) !important;
                        color: #f9fafb !important;
                        border-color: rgba(255, 255, 255, 0.18) !important;
                    }

                    .profile-theme .profile-content input::placeholder,
                    .profile-theme .profile-content textarea::placeholder {
            ...
            {/* Header Navigation */}
            <header className="relative z-10 border-b border-white/10 bg-[#0E121B]/85 backdrop-blur-xl">
                    ...
                    <div className="flex items-center justify-between">
                        ...
                        {isOwnProfile && !isEditing && (
                            <button
                                ...
                                className="flex items-center gap-2 rounded-lg border border-white/15 bg-white/5 px-4 py-2 font-medium text-gray-200 transition-all hover:bg-white/10"
                            >
                        ...
                        {isEditing && (
                            <div className="flex items-center gap-2">
                                <button
                                    ...
                                    className="rounded-lg border border-white/15 bg-white/5 px-4 py-2 font-medium text-gray-200 transition-all hover:bg-white/10"
                                >
                                    Cancel
                                </button>
                                <button
            ...
            <div className="profile-content relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
                {/* Profile Header Card */}
                <div className="overflow-hidden rounded-2xl bg-white shadow-lg border border-gray-200">
                    {/* Cover Banner */}
                    <div
                        className="h-48 bg-gradient-to-r from-blue-600 via-indigo-600 to-indigo-700 relative bg-cover bg-center"
                    ...
                    >
                        ...
                        {isOwnProfile && !isEditing && (
                            <label className="absolute right-4 top-4 z-20 flex cursor-pointer items-center gap-2 rounded-lg border border-white/20 bg-black/40 px-3 py-2 text-sm font-medium text-white backdrop-blur-sm transition-all hover:bg-black/55">
                                <input
                                    type="file"
                                    className="hidden"
                                    accept="image/*"
                                ...
                                {uploadingBanner ? (
                                    ...
                                    <svg className="h-4 w-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 9a2 2 0 012-2h3.28a2 2 0 001.789-1.106l.553-1.106A2 2 0 0112.412 4h.176a2 2 0 011.79 1.106l.552 1.106A2 2 0 0016.72 7H20a2 2 0 012 2v8a2 2 0 01-2 2H5a2 2 0 01-2-2V9z" />
