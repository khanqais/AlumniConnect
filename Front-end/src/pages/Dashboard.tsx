...
const Dashboard = () => {
  ...
  const scheduleCall = async () => {
    try {
      const startTime = new Date(Date.now() + 10 * 60 * 1000); // 10 min later
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-gray-100">
      ...
      <main className="relative z-10 mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        {/* Profile */}
        <div className="mb-8 max-w-sm rounded-2xl border border-gray-200 bg-white p-6 shadow-sm">
          <p className="text-sm font-medium text-gray-600">Your Profile</p>
        ...
        <div className="mb-8">
          ...
          <div className="group rounded-2xl border border-gray-200 bg-white p-6 shadow-sm transition-all hover:border-blue-500 hover:shadow-md mt-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900">Find Mentors for choosing appropriate career path</h3>
            <p className="mt-2 text-sm text-gray-600">
