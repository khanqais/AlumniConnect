                        ...
                        <div className="relative -mt-16 flex items-end gap-6">
                            <div className="relative">
                                {profile.avatar ? (
                                    ...
                                    <div className="flex h-32 w-32 items-center justify-center rounded-full border-4 border-white bg-gradient-to-br from-indigo-500 to-purple-600 shadow-lg">
                                ...
                                {isOwnProfile && !isEditing && (
                                    <label className="absolute bottom-0 right-0 flex h-10 w-10 cursor-pointer items-center justify-center rounded-full bg-indigo-600 text-white shadow-lg transition-all hover:bg-indigo-700">
                                        <input
                                            type="file"
                                            className="hidden"
                                            accept="image/*"
                            ...
                            <div className="flex-1 pb-4">
                                {isEditing ? (
                                    <input
                                        ...
                                        className="w-full rounded-lg border border-gray-300 px-4 py-2 text-2xl font-bold focus:border-indigo-500 focus:outline-none focus:ring-2 focus:ring-indigo-500"
                                    />
                                ) : (
                            ...
                            <div className="rounded-xl bg-white p-6 shadow">
                                ...
                                {isEditing ? (
                                    ...
                                    <div className="space-y-2">
                                        {profile.experience && (
                                            <p className="text-gray-600">{profile.experience} of experience</p>
                                        )}
                                    </div>
                                )}
                            </div>
                                    ...
                                    <div>
                                        ...
                                        {isEditing ? (
                                            <input
                                                ...
                                                onChange={handleInputChange}
                                                className="w-full rounded-lg border border-gray-300 px-3 py-1 focus:border-indigo-500 focus:outline-none"
                                            />
                                        ) : (
