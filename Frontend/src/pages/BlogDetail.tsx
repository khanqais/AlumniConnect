                ...
                <div className="flex h-screen items-center justify-center">
                    <div className="text-center">
                        ...
                        <button
                            ...
                            className="mt-4 rounded-lg bg-amber-500 px-4 py-2 text-[#111827] hover:bg-amber-400"
                        >
                            Back to Blogs
                        </button>
                    </div>
                        ...
                        <div className="flex items-center gap-4 text-sm text-gray-400">
                            ...
                            {(blog.author._id === user?._id || user?.role === 'admin') && (
                                <button
                                    ...
                                    className="flex items-center gap-1 transition-colors text-red-400 hover:text-red-300"
                                    title="Delete blog"
                                >
                            ...
                            <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                    <img
                                        ...
                                        onError={(e) => {
                                            const target = e.currentTarget;
                                            const fallback = `https://ui-avatars.com/api/?name=${encodeURIComponent(user.name || 'User')}&background=1F2937&color=F9FAFB&bold=true`;
                                            if (target.src !== fallback) target.src = fallback;
                                        }}
                                    ...
                                    <div className="mb-3 flex items-start gap-3">
                                        <img
                                            src={resolveAvatarUrl(
                                                typeof comment.user === 'object' ? comment.user?.avatar : undefined,
                                                comment.userName
                                            )}
