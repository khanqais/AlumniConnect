...
type FilterType = 'all' | 'resource' | 'blog' | 'question' | 'event';
        ...
        <div className="flex flex-col gap-4">
            ...
            <div className="flex items-center justify-between">
                ...
                <button
                    ...
                    className="flex items-center gap-1.5 rounded-lg border border-gray-200 bg-white px-3 py-1.5 text-sm text-gray-600 shadow-sm transition hover:bg-gray-50 hover:text-gray-900"
                    title="Refresh feed"
                >
            ...
            {loading ? (
                ...
                <div className="rounded-xl border border-red-100 bg-red-50 p-6 text-center">
                    <svg className="mx-auto mb-2 h-8 w-8 text-red-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <>
                    ...
                    {hasMore && (
                        <button
                            ...
                            className="w-full rounded-xl border border-gray-200 bg-white py-3 text-sm font-medium text-gray-600 shadow-sm transition hover:bg-gray-50 disabled:opacity-60"
                        >
                            {loadingMore ? (
